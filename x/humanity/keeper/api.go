...
const T = {
en:{
'tab-register':'🔐 Register','tab-explorer':'🔍 Explorer','tab-humans':'👥 Humans','tab-index':'📊 Index','tab-network':'🌐 Network',
'connect-btn':'🦊 CONNECT METAMASK','register-btn':'🔐 REGISTER ON-CHAIN',
'reg-hint':'// Open Aequitas Android App to generate your proof, then return here to complete registration...',
'add-network':'+ ADD AEQUITAS NETWORK',
'philosophy':'"Money exists because people exist.<br>Nothing more, nothing less."',
'philosophy-sub':'— THE AEQUITAS PRINCIPLE —',
'reg-title':'🔐 Register as a Verified Human',
'reg-sub':'Join the Aequitas network and receive your 1,000 AEQ. One-time, permanent, gasless — cryptographically proving you are a unique human. No personal data stored. No gas fees.',
'app-only-title':'REGISTRATION VIA ANDROID APP ONLY',
'app-only-text':'Proof of Humanity requires biometric verification on your personal device. Your fingerprint is processed by the Hardware Secure Element — a dedicated chip that cannot be accessed remotely. The raw fingerprint data never leaves your phone. Download the Aequitas App, scan your fingerprint, connect your MetaMask wallet, and your <strong style="color:var(--gold)">1,000 AEQ will be granted automatically</strong>.',
'step1-title':'Biometric Scan','step1-desc':'Open app · scan fingerprint · processed by Hardware Secure Element · data never leaves device',
'step2-title':'ZKP Generation','step2-desc':'Groth16 proof generated · uniqueness verified · biometric hash never revealed',
'step3-title':'Connect Wallet','step3-desc':'App opens MetaMask · connect your wallet · address receives 1,000 AEQ permanently',
'step4-title':'1,000 AEQ','step4-desc':'Registered on Aequitas V6 · confirmed in next block · app notifies automatically',
...
'reg-details':'Registration Details',
'live-stats':'Live Chain Statistics',
'block-height':'Block Height','block-height-sub':'New block every 6s · BlockDAG · Two nodes parallel',
'verified-humans':'Verified Humans','verified-humans-sub':'Biometric ZKP · One person, one wallet, forever',
'total-supply':'Total Supply','total-supply-sub':'Always = Humans × 1,000 AEQ',
'aeq-index':'Aequitas Index','aeq-index-sub':'0 = perfect equality · 100 = max inequality',
'uptime':'Uptime','uptime-sub':'Node v0.3.0 · Railway + Render · PostgreSQL',
'poh-title':'Proof of Humanity','poh-text':'Every AEQ holder must prove they are a unique living human through biometric verification. No bots, no corporations, no AI can hold AEQ. Only real humans. Your fingerprint is processed by the Hardware Secure Element. Biometric data never leaves your device.',
'fair-title':'Radically Fair Distribution','fair-text':'Every verified human receives exactly 1,000 AEQ. First person and billionth person receive identical amounts. No pre-mine, no founder allocation, no investor round. Total supply always equals verified humans × 1,000.',
'dag-title':'BlockDAG Architecture','dag-text':'Multiple blocks can be produced simultaneously by different nodes and merged. Higher throughput, lower latency, better fault tolerance. Merge events marked 🔀 in the explorer.',
'gasless-title':'Truly Gasless','gasless-text':'Registration costs absolutely nothing. No ETH, BNB, or MATIC required. No credit card, no bank account. If you are a human with a smartphone, you can register.',
'recent-blocks':'Recent Blocks','blocks-desc':'🔀 MERGE = multiple parents (BlockDAG). ✅ TX = registration transaction. Block time: ~6 seconds.',
'network-info':'Network Info','chain-name':'Chain Name','symbol':'Symbol','block-time':'Block Time','consensus':'Consensus','nodes':'Active Nodes','storage':'Storage',
'add-metamask':'🦊 ADD TO METAMASK','network-name':'Network Name','decimals':'Decimals',
'registered-humans':'Registered Humans','humans-desc':'Every address verified as unique human through biometric ZKP. Each received 1,000 AEQ. Permanent, immutable.',
'no-humans':'No humans registered yet.

Download the Aequitas Android App and be the first human on the chain!',
'registry-stats':'Registry Stats','total-humans-stat':'Total Humans','grant':'Grant per Human','reg-fee':'Registration Fee','free':'FREE','zkp-system':'ZKP System','never-stored':'Never stored',
'aeq-index-title':'Aequitas Index — Real-Time Economic Equality Score',
'current-index':'Current Index','gini-coeff':'Gini Coefficient','phase':'Protocol Phase',
'pools-title':'Redistribution Pools','vel-pool':'Velocity Pool','liq-pool':'Liquidity Pool','uni-pool':'UBI Pool','treasury':'Treasury',
'phases-title':'Protocol Phases',
'phase0':'Bootstrap · &lt;100 humans · Cap: 50x fairShare',
'phase1':'Growth · 100–10,000 · Cap: 20x fairShare',
'phase2':'Stability · 10k–1M · Cap: 10x fairShare',
'phase3':'Maturity · 1M+ · Cap: 3x fairShare',
'active-nodes':'Active Nodes','node1':'Node 1 — Railway (Primary)','node2':'Node 2 — Render (Secondary)',
'node1-desc':'Primary API · Block producer · P2P bootstrap · PostgreSQL · RPC for MetaMask',
'node2-desc':'Secondary API · Block producer · P2P peer · HTTP sync · Shared PostgreSQL',
'tech-specs':'Technical Specifications','metamask-config':'MetaMask Configuration'
},
de:{
'tab-register':'🔐 Registrieren','tab-explorer':'🔍 Explorer','tab-humans':'👥 Menschen','tab-index':'📊 Index','tab-network':'🌐 Netzwerk',
'connect-btn':'🦊 METAMASK VERBINDEN','register-btn':'🔐 ON-CHAIN REGISTRIEREN',
'reg-hint':'// Öffne die Aequitas Android-App um deinen Beweis zu generieren, dann kehre hierher zurück...',
'add-network':'+ AEQUITAS-NETZWERK HINZUFÜGEN',
'philosophy':'"Geld existiert weil Menschen existieren.<br>Nichts mehr, nichts weniger."',
'philosophy-sub':'— DAS AEQUITAS-PRINZIP —',
...
'app-only-title':'REGISTRIERUNG NUR ÜBER ANDROID-APP',
'app-only-text':'Der Menschlichkeitsnachweis erfordert biometrische Verifizierung auf deinem Gerät. Dein Fingerabdruck wird durch das Hardware Secure Element verarbeitet — rohe Daten verlassen niemals dein Telefon. Lade die Aequitas-App herunter, scanne deinen Fingerabdruck, verbinde deine MetaMask-Wallet, und deine <strong style="color:var(--gold)">1.000 AEQ werden automatisch gewährt</strong>.',
'step1-title':'Biometrischer Scan','step1-desc':'App öffnen · Fingerabdruck scannen · durch Hardware Secure Element verarbeitet · Daten verlassen nie das Gerät',
'step2-title':'ZKP-Erzeugung','step2-desc':'Groth16-Beweis generiert · Einzigartigkeit verifiziert · Biometrischer Hash nie enthüllt',
'step3-title':'Wallet verbinden','step3-desc':'App öffnet MetaMask · Wallet verbinden · Adresse erhält 1.000 AEQ dauerhaft',
'step4-title':'1.000 AEQ','step4-desc':'Auf Aequitas V6 registriert · im nächsten Block bestätigt · App benachrichtigt automatisch',
...
'reg-details':'Registrierungsdetails',
'live-stats':'Live Chain-Statistiken',
'block-height':'Blockhöhe','block-height-sub':'Neuer Block alle 6 Sek · BlockDAG · Zwei Nodes parallel',
'verified-humans':'Verifizierte Menschen','verified-humans-sub':'Biometrischer ZKP · Eine Person, eine Wallet, für immer',
'total-supply':'Gesamtmenge','total-supply-sub':'Immer = Menschen × 1.000 AEQ',
'aeq-index':'Aequitas-Index','aeq-index-sub':'0 = vollkommene Gleichheit · 100 = maximale Ungleichheit',
'uptime':'Betriebszeit','uptime-sub':'Node v0.3.0 · Railway + Render · PostgreSQL',
'poh-title':'Menschlichkeitsnachweis','poh-text':'Jeder AEQ-Inhaber muss beweisen, dass er ein einzigartiger lebender Mensch ist. Keine Bots, keine Unternehmen, keine KI kann AEQ halten. Nur echte Menschen. Biometrische Daten verlassen niemals dein Gerät.',
'fair-title':'Radikal faire Verteilung','fair-text':'Jeder verifizierte Mensch erhält genau 1.000 AEQ. Keine Vorzuteilung, keine Gründeranteile. Die Gesamtmenge entspricht immer Menschen × 1.000.',
'dag-title':'BlockDAG-Architektur','dag-text':'Mehrere Blöcke können gleichzeitig produziert und zusammengeführt werden. Höherer Durchsatz, niedrigere Latenz, bessere Fehlertoleranz.',
'gasless-title':'Wirklich gebührenfrei','gasless-text':'Registrierung kostet absolut nichts. Kein ETH, BNB oder MATIC benötigt. Kein Bankkonto erforderlich.',
...
'network-info':'Netzwerkinformationen','chain-name':'Netzwerkname','symbol':'Symbol','block-time':'Blockzeit','consensus':'Konsens','nodes':'Aktive Nodes','storage':'Speicher',
'add-metamask':'🦊 ZU METAMASK HINZUFÜGEN','network-name':'Netzwerkname','decimals':'Dezimalstellen',
'registered-humans':'Registrierte Menschen','humans-desc':'Jede Adresse als einzigartiger Mensch durch biometrischen ZKP verifiziert. Jeder erhielt 1.000 AEQ. Dauerhaft, unveränderlich.',
'no-humans':'Noch keine Menschen registriert.

Lade die Aequitas Android-App herunter und sei der erste Mensch auf der Chain!',
'registry-stats':'Registrierungsstatistik','total-humans-stat':'Gesamte Menschen','grant':'Zuteilung pro Mensch','reg-fee':'Registrierungsgebühr','free':'KOSTENLOS','zkp-system':'ZKP-System','never-stored':'Niemals gespeichert',
'aeq-index-title':'Aequitas-Index — Wirtschaftlicher Gleichheitswert in Echtzeit',
'current-index':'Aktueller Index','gini-coeff':'Gini-Koeffizient','phase':'Protokollphase',
'pools-title':'Umverteilungspools','vel-pool':'Velocity-Pool','liq-pool':'Liquiditäts-Pool','uni-pool':'UBI-Pool','treasury':'Tresor',
'phases-title':'Protokollphasen',
'phase0':'Bootstrap · &lt;100 Menschen · Cap: 50x fairShare',
'phase1':'Wachstum · 100–10.000 · Cap: 20x fairShare',
'phase2':'Stabilität · 10k–1M · Cap: 10x fairShare',
'phase3':'Reife · 1M+ · Cap: 3x fairShare',
'active-nodes':'Aktive Nodes','node1':'Node 1 — Railway (Primär)','node2':'Node 2 — Render (Sekundär)',
'node1-desc':'Primärer API-Server · Blockproduzent · P2P-Bootstrap · PostgreSQL · RPC für MetaMask',
'node2-desc':'Sekundärer API-Server · Blockproduzent · P2P-Peer · HTTP-Sync · Geteiltes PostgreSQL',
'tech-specs':'Technische Spezifikationen','metamask-config':'MetaMask-Konfiguration'
},
es:{
'tab-register':'🔐 Registrar','tab-explorer':'🔍 Explorador','tab-humans':'👥 Humanos','tab-index':'📊 Índice','tab-network':'🌐 Red',
'connect-btn':'🦊 CONECTAR METAMASK','register-btn':'🔐 REGISTRAR ON-CHAIN',
'reg-hint':'// Abre la App Android Aequitas para generar tu prueba, luego regresa aquí...',
'add-network':'+ AGREGAR RED AEQUITAS',
'philosophy':'"El dinero existe porque las personas existen.<br>Nada más, nada menos."',
'philosophy-sub':'— EL PRINCIPIO AEQUITAS —',
'reg-title':'🔐 Regístrate como Humano Verificado',
'reg-sub':'Únete a la red Aequitas y recibe 1,000 AEQ. Único, permanente, sin gas. Sin datos personales almacenados.',
'app-only-title':'REGISTRO SOLO VÍA APP ANDROID',
'app-only-text':'La Prueba de Humanidad requiere verificación biométrica en tu dispositivo. Tu huella se procesa por el Elemento Seguro de Hardware — los datos brutos nunca salen de tu teléfono. Descarga la app, escanea tu huella, conecta tu wallet, y tus <strong style="color:var(--gold)">1,000 AEQ serán otorgados automáticamente</strong>.',
'step1-title':'Escaneo Biométrico','step1-desc':'Abrir app · escanear huella · procesado por Hardware Secure Element · datos nunca salen del dispositivo',
'step2-title':'Generación ZKP','step2-desc':'Prueba Groth16 generada · unicidad verificada · hash biométrico nunca revelado',
'step3-title':'Conectar Wallet','step3-desc':'App abre MetaMask · conectar wallet · dirección recibe 1,000 AEQ permanentemente',
'step4-title':'1,000 AEQ','step4-desc':'Registrado en Aequitas V6 · confirmado en próximo bloque · app notifica automáticamente',
'priv-bar':'🔒 Elemento Seguro de Hardware · ZKP Groth16 · Datos nunca salen del dispositivo · Sin tarifas de gas',
'connected-wallet':'WALLET CONECTADA','reg-details':'Detalles del Registro',
'live-stats':'Estadísticas de Cadena en Vivo',
'block-height':'Altura de Bloque','block-height-sub':'Nuevo bloque cada 6s · BlockDAG · Dos nodos paralelos',
'verified-humans':'Humanos Verificados','verified-humans-sub':'ZKP biométrico · Una persona, una wallet, siempre',
'total-supply':'Suministro Total','total-supply-sub':'Siempre = Humanos × 1,000 AEQ',
'aeq-index':'Índice Aequitas','aeq-index-sub':'0 = igualdad perfecta · 100 = desigualdad máxima',
'uptime':'Tiempo Activo','uptime-sub':'Node v0.3.0 · Railway + Render · PostgreSQL',
'poh-title':'Prueba de Humanidad','poh-text':'Cada titular de AEQ debe probar que es un humano único vivo. Sin bots, sin corporaciones, sin IA. Solo humanos reales. Los datos biométricos nunca salen de tu dispositivo.',
'fair-title':'Distribución Radicalmente Justa','fair-text':'Cada humano verificado recibe exactamente 1,000 AEQ. Sin pre-minado, sin asignación a fundadores. El suministro siempre es humanos × 1,000.',
'dag-title':'Arquitectura BlockDAG','dag-text':'Múltiples bloques pueden producirse simultáneamente y fusionarse. Mayor rendimiento, menor latencia, mejor tolerancia a fallos.',
'gasless-title':'Verdaderamente Sin Gas','gasless-text':'El registro no cuesta nada. No se necesita ETH, BNB ni MATIC. Sin tarjeta de crédito ni cuenta bancaria.',
...
'network-info':'Información de Red','chain-name':'Nombre de Red','symbol':'Símbolo','block-time':'Tiempo de Bloque','consensus':'Consenso','nodes':'Nodos Activos','storage':'Almacenamiento',
'add-metamask':'🦊 AGREGAR A METAMASK','network-name':'Nombre de Red','decimals':'Decimales',
'registered-humans':'Humanos Registrados','humans-desc':'Cada dirección verificada como humano único mediante ZKP biométrico. Cada uno recibió 1,000 AEQ. Permanente e inmutable.',
'no-humans':'No hay humanos registrados aún.

¡Descarga la App Android Aequitas y sé el primero!',
'registry-stats':'Estadísticas del Registro','total-humans-stat':'Total de Humanos','grant':'Bono por Humano','reg-fee':'Tarifa de Registro','free':'GRATIS','zkp-system':'Sistema ZKP','never-stored':'Nunca almacenado',
'aeq-index-title':'Índice Aequitas — Puntuación de Igualdad Económica en Tiempo Real',
'current-index':'Índice Actual','gini-coeff':'Coeficiente Gini','phase':'Fase del Protocolo',
'pools-title':'Pools de Redistribución','vel-pool':'Pool Velocidad','liq-pool':'Pool Liquidez','uni-pool':'Pool UBI','treasury':'Tesorería',
'phases-title':'Fases del Protocolo',
'phase0':'Bootstrap · &lt;100 humanos · Cap: 50x fairShare',
'phase1':'Crecimiento · 100–10,000 · Cap: 20x fairShare',
'phase2':'Estabilidad · 10k–1M · Cap: 10x fairShare',
'phase3':'Madurez · 1M+ · Cap: 3x fairShare',
'active-nodes':'Nodos Activos','node1':'Nodo 1 — Railway (Primario)','node2':'Nodo 2 — Render (Secundario)',
'node1-desc':'Servidor API primario · Productor de bloques · P2P bootstrap · PostgreSQL · RPC para MetaMask',
'node2-desc':'Servidor API secundario · Productor de bloques · Par P2P · Sincronización HTTP · PostgreSQL compartido',
'tech-specs':'Especificaciones Técnicas','metamask-config':'Configuración MetaMask'
},
ru:{
'tab-register':'🔐 Регистрация','tab-explorer':'🔍 Проводник','tab-humans':'👥 Люди','tab-index':'📊 Индекс','tab-network':'🌐 Сеть',
'connect-btn':'🦊 ПОДКЛЮЧИТЬ METAMASK','register-btn':'🔐 ЗАРЕГИСТРИРОВАТЬСЯ ON-CHAIN',
'reg-hint':'// Откройте Android-приложение Aequitas для генерации доказательства, затем вернитесь сюда...',
'add-network':'+ ДОБАВИТЬ СЕТЬ AEQUITAS',
'philosophy':'"Деньги существуют потому что существуют люди.<br>Ничего больше, ничего меньше."',
'philosophy-sub':'— ПРИНЦИП AEQUITAS —',
'reg-title':'🔐 Зарегистрируйтесь как Верифицированный Человек',
'reg-sub':'Присоединитесь к сети Aequitas и получите 1 000 AEQ. Одноразово, постоянно, бесплатно. Никакие личные данные не хранятся.',
'app-only-title':'РЕГИСТРАЦИЯ ТОЛЬКО ЧЕРЕЗ ANDROID-ПРИЛОЖЕНИЕ',
'app-only-text':'Доказательство человечности требует биометрической верификации на вашем устройстве. Ваш отпечаток обрабатывается Hardware Secure Element — сырые данные никогда не покидают ваш телефон. Скачайте приложение, отсканируйте отпечаток, подключите кошелёк, и ваши <strong style="color:var(--gold)">1 000 AEQ будут начислены автоматически</strong>.',
'step1-title':'Биометрический Скан','step1-desc':'Открыть приложение · сканировать отпечаток · обработан Hardware Secure Element · данные не покидают устройство',
'step2-title':'Генерация ZKP','step2-desc':'Сгенерировано доказательство Groth16 · уникальность верифицирована · биометрический хэш не раскрывается',
'step3-title':'Подключить Кошелёк','step3-desc':'Приложение открывает MetaMask · подключить кошелёк · адрес получает 1 000 AEQ постоянно',
'step4-title':'1 000 AEQ','step4-desc':'Зарегистрировано на Aequitas V6 · подтверждено в следующем блоке · приложение уведомляет автоматически',
'priv-bar':'🔒 Hardware Secure Element · ZKP Groth16 · Данные не покидают устройство · Без комиссий · Постоянная защита',
'connected-wallet':'ПОДКЛЮЧЁННЫЙ КОШЕЛЁК','reg-details':'Детали Регистрации',
'live-stats':'Статистика цепочки в реальном времени',
'block-height':'Высота Блока','block-height-sub':'Новый блок каждые 6 сек · BlockDAG · Два узла параллельно',
'verified-humans':'Верифицированных Людей','verified-humans-sub':'Биометрический ZKP · Один человек, один кошелёк, навсегда',
'total-supply':'Общее Предложение','total-supply-sub':'Всегда = Люди × 1 000 AEQ',
'aeq-index':'Индекс Aequitas','aeq-index-sub':'0 = полное равенство · 100 = максимальное неравенство',
'uptime':'Время Работы','uptime-sub':'Node v0.3.0 · Railway + Render · PostgreSQL',
'poh-title':'Доказательство Человечности','poh-text':'Каждый владелец AEQ должен доказать, что он уникальный живой человек. Никаких ботов, корпораций, ИИ. Только настоящие люди. Биометрические данные никогда не покидают устройство.',
'fair-title':'Радикально Справедливое Распределение','fair-text':'Каждый верифицированный человек получает ровно 1 000 AEQ. Без предварительной добычи, без доли основателей. Общее предложение всегда равно людям × 1 000.',
'dag-title':'Архитектура BlockDAG','dag-text':'Несколько блоков могут производиться одновременно и объединяться. Более высокая пропускная способность, меньшая задержка.',
'gasless-title':'По-Настоящему Бесплатно','gasless-text':'Регистрация не стоит ничего. Не нужен ETH, BNB или MATIC. Не нужен банковский счёт.',
...
'network-info':'Информация о Сети','chain-name':'Название Сети','symbol':'Символ','block-time':'Время Блока','consensus':'Консенсус','nodes':'Активные Узлы','storage':'Хранение',
'add-metamask':'🦊 ДОБАВИТЬ В METAMASK','network-name':'Название Сети','decimals':'Знаков после запятой',
'registered-humans':'Зарегистрированных Людей','humans-desc':'Каждый адрес верифицирован как уникальный человек через биометрический ZKP. Каждый получил 1 000 AEQ. Постоянно, неизменно.',
'no-humans':'Людей ещё нет.

Скачай приложение Aequitas Android и стань первым!',
'registry-stats':'Статистика Реестра','total-humans-stat':'Всего Людей','grant':'Грант на Человека','reg-fee':'Плата за Регистрацию','free':'БЕСПЛАТНО','zkp-system':'Система ZKP','never-stored':'Никогда не хранится',
'aeq-index-title':'Индекс Aequitas — Оценка Экономического Равенства в Реальном Времени',
'current-index':'Текущий Индекс','gini-coeff':'Коэффициент Джини','phase':'Фаза Протокола',
'pools-title':'Пулы Перераспределения','vel-pool':'Пул Скорости','liq-pool':'Пул Ликвидности','uni-pool':'Пул UBI','treasury':'Казначейство',
'phases-title':'Фазы Протокола',
'phase0':'Загрузка · &lt;100 людей · Cap: 50x fairShare',
'phase1':'Рост · 100–10 000 · Cap: 20x fairShare',
'phase2':'Стабильность · 10k–1M · Cap: 10x fairShare',
'phase3':'Зрелость · 1M+ · Cap: 3x fairShare',
'active-nodes':'Активные Узлы','node1':'Узел 1 — Railway (Основной)','node2':'Узел 2 — Render (Вторичный)',
'node1-desc':'Основной API-сервер · Производитель блоков · P2P-bootstrap · PostgreSQL · RPC для MetaMask',
'node2-desc':'Вторичный API-сервер · Производитель блоков · P2P-пир · HTTP-синхронизация · Общий PostgreSQL',
'tech-specs':'Технические Характеристики','metamask-config':'Настройка MetaMask'
},
zh:{
'tab-register':'🔐 注册','tab-explorer':'🔍 浏览器','tab-humans':'👥 人类','tab-index':'📊 指数','tab-network':'🌐 网络',
'connect-btn':'🦊 连接METAMASK','register-btn':'🔐 链上注册',
'reg-hint':'// 打开Aequitas Android应用生成您的证明，然后返回此处...',
'add-network':'+ 添加AEQUITAS网络',
'philosophy':'"货币存在是因为人类存在。<br>仅此而已，不多也不少。"',
'philosophy-sub':'— AEQUITAS原则 —',
'reg-title':'🔐 注册为已验证人类',
'reg-sub':'加入Aequitas网络并接收1,000 AEQ。一次性、永久、无Gas费。不存储个人数据。',
'app-only-title':'仅通过ANDROID应用注册',
'app-only-text':'人类证明需要在您的个人设备上进行生物特征验证。您的指纹由硬件安全元件处理——原始数据永远不会离开您的手机。下载应用，扫描指纹，连接钱包，您的<strong style="color:var(--gold)">1,000 AEQ将自动发放</strong>。',
'step1-title':'生物特征扫描','step1-desc':'打开应用 · 扫描指纹 · 由硬件安全元件处理 · 数据永不离开设备',
'step2-title':'ZKP生成','step2-desc':'生成Groth16证明 · 验证唯一性 · 生物特征哈希从不泄露',
'step3-title':'连接钱包','step3-desc':'应用打开MetaMask · 连接钱包 · 地址永久接收1,000 AEQ',
'step4-title':'1,000 AEQ','step4-desc':'在Aequitas V6上注册 · 下一个区块内确认 · 应用自动通知',
'priv-bar':'🔒 硬件安全元件 · Groth16 ZKP · 数据永不离开设备 · 无Gas费 · 永久女巫攻击防护',
'connected-wallet':'已连接钱包','reg-details':'注册详情',
'live-stats':'链上实时统计',
'block-height':'区块高度','block-height-sub':'每6秒新区块 · BlockDAG · 两个节点并行',
'verified-humans':'已验证人类','verified-humans-sub':'生物特征ZKP · 一人一钱包，永久',
'total-supply':'总供应量','total-supply-sub':'始终 = 人类 × 1,000 AEQ',
'aeq-index':'Aequitas指数','aeq-index-sub':'0 = 完全平等 · 100 = 最大不平等',
'uptime':'运行时间','uptime-sub':'Node v0.3.0 · Railway + Render · PostgreSQL',
'poh-title':'人类证明','poh-text':'每个AEQ持有者必须证明自己是唯一的活人。没有机器人、公司或AI可以持有AEQ。只有真实的人类。生物特征数据永不离开您的设备。',
'fair-title':'根本公平的分配','fair-text':'每个经过验证的人类获得恰好1,000 AEQ。没有预挖，没有创始人分配。总供应量始终等于已验证人类 × 1,000。',
'dag-title':'BlockDAG架构','dag-text':'多个区块可以同时产生并合并。更高吞吐量，更低延迟，更好容错性。',
'gasless-title':'真正无Gas费','gasless-text':'注册绝对免费。不需要ETH、BNB或MATIC。不需要银行账户。',
'recent-blocks':'最近区块','blocks-desc':'🔀 MERGE = 多个父区块（BlockDAG）。✅ TX = 注册交易。区块时间：约6秒。',
'network-info':'网络信息','chain-name':'网络名称','symbol':'符号','block-time':'出块时间','consensus':'共识','nodes':'活跃节点','storage':'存储',
'add-metamask':'🦊 添加到METAMASK','network-name':'网络名称','decimals':'小数位',
'registered-humans':'已注册人类','humans-desc':'每个地址通过生物特征ZKP验证为唯一人类。每人获得1,000 AEQ。永久，不可变。',
'no-humans':'还没有人类注册。

下载Aequitas Android应用成为第一个！',
'registry-stats':'注册统计','total-humans-stat':'总人类数','grant':'每人补助','reg-fee':'注册费','free':'免费','zkp-system':'ZKP系统','never-stored':'从不存储',
'aeq-index-title':'Aequitas指数 — 实时经济平等分数',
'current-index':'当前指数','gini-coeff':'基尼系数','phase':'协议阶段',
'pools-title':'再分配池','vel-pool':'速度池','liq-pool':'流动性池','uni-pool':'UBI池','treasury':'国库',
'phases-title':'协议阶段',
'phase0':'引导期 · &lt;100人 · Cap: 50x fairShare',
'phase1':'增长期 · 100–10,000 · Cap: 20x fairShare',
'phase2':'稳定期 · 10k–1M · Cap: 10x fairShare',
'phase3':'成熟期 · 1M+ · Cap: 3x fairShare',
'active-nodes':'活跃节点','node1':'节点1 — Railway（主要）','node2':'节点2 — Render（次要）',
'node1-desc':'主要API服务器 · 区块生产者 · P2P引导 · PostgreSQL · MetaMask的RPC',
'node2-desc':'次要API服务器 · 区块生产者 · P2P对等 · HTTP同步 · 共享PostgreSQL',
'tech-specs':'技术规格','metamask-config':'MetaMask配置'
},
id:{
'tab-register':'🔐 Daftar','tab-explorer':'🔍 Penjelajah','tab-humans':'👥 Manusia','tab-index':'📊 Indeks','tab-network':'🌐 Jaringan',
'connect-btn':'🦊 HUBUNGKAN METAMASK','register-btn':'🔐 DAFTAR ON-CHAIN',
'reg-hint':'// Buka Aplikasi Android Aequitas untuk menghasilkan bukti Anda, lalu kembali ke sini...',
'add-network':'+ TAMBAHKAN JARINGAN AEQUITAS',
'philosophy':'"Uang ada karena manusia ada.<br>Tidak lebih, tidak kurang."',
'philosophy-sub':'— PRINSIP AEQUITAS —',
'reg-title':'🔐 Daftar sebagai Manusia Terverifikasi',
'reg-sub':'Bergabunglah dengan jaringan Aequitas dan terima 1.000 AEQ. Sekali, permanen, tanpa gas. Tidak ada data pribadi disimpan.',
'app-only-title':'PENDAFTARAN HANYA MELALUI APLIKASI ANDROID',
...
'step1-title':'Pemindaian Biometrik','step1-desc':'Buka aplikasi · pindai sidik jari · diproses oleh Hardware Secure Element · data tidak pernah meninggalkan perangkat',
'step2-title':'Pembuatan ZKP','step2-desc':'Bukti Groth16 dihasilkan · keunikan diverifikasi · hash biometrik tidak pernah terungkap',
'step3-title':'Hubungkan Wallet','step3-desc':'Aplikasi membuka MetaMask · hubungkan wallet · alamat menerima 1.000 AEQ secara permanen',
'step4-title':'1.000 AEQ','step4-desc':'Terdaftar di Aequitas V6 · dikonfirmasi di blok berikutnya · aplikasi memberi tahu otomatis',
'priv-bar':'🔒 Hardware Secure Element · ZKP Groth16 · Data tidak pernah meninggalkan perangkat · Tanpa biaya gas',
'connected-wallet':'DOMPET TERHUBUNG','reg-details':'Detail Pendaftaran',
'live-stats':'Statistik Rantai Langsung',
'block-height':'Tinggi Blok','block-height-sub':'Blok baru setiap 6 detik · BlockDAG · Dua node paralel',
'verified-humans':'Manusia Terverifikasi','verified-humans-sub':'ZKP biometrik · Satu orang, satu wallet, selamanya',
'total-supply':'Total Pasokan','total-supply-sub':'Selalu = Manusia × 1.000 AEQ',
'aeq-index':'Indeks Aequitas','aeq-index-sub':'0 = kesetaraan sempurna · 100 = ketidaksetaraan maksimum',
'uptime':'Waktu Aktif','uptime-sub':'Node v0.3.0 · Railway + Render · PostgreSQL',
'poh-title':'Bukti Kemanusiaan','poh-text':'Setiap pemegang AEQ harus membuktikan bahwa mereka adalah manusia unik yang hidup. Tidak ada bot, korporasi, atau AI yang bisa memegang AEQ. Hanya manusia nyata. Data biometrik tidak pernah meninggalkan perangkat.',
'fair-title':'Distribusi yang Benar-Benar Adil','fair-text':'Setiap manusia terverifikasi menerima tepat 1.000 AEQ. Tanpa pre-mine, tanpa alokasi pendiri. Total pasokan selalu sama dengan manusia × 1.000.',
'dag-title':'Arsitektur BlockDAG','dag-text':'Beberapa blok dapat diproduksi secara bersamaan dan digabungkan. Throughput lebih tinggi, latensi lebih rendah, toleransi kesalahan lebih baik.',
'gasless-title':'Benar-Benar Tanpa Gas','gasless-text':'Pendaftaran tidak memerlukan biaya sama sekali. Tidak perlu ETH, BNB, atau MATIC. Tidak perlu rekening bank.',
'recent-blocks':'Blok Terbaru','blocks-desc':'🔀 MERGE = beberapa induk (BlockDAG). ✅ TX = transaksi registrasi. Waktu blok: ~6 detik.',
'network-info':'Informasi Jaringan','chain-name':'Nama Jaringan','symbol':'Simbol','block-time':'Waktu Blok','consensus':'Konsensus','nodes':'Node Aktif','storage':'Penyimpanan',
'add-metamask':'🦊 TAMBAHKAN KE METAMASK','network-name':'Nama Jaringan','decimals':'Desimal',
'registered-humans':'Manusia Terdaftar','humans-desc':'Setiap alamat diverifikasi sebagai manusia unik melalui ZKP biometrik. Masing-masing menerima 1.000 AEQ. Permanen, tidak dapat diubah.',
'no-humans':'Belum ada manusia terdaftar.

Unduh Aplikasi Android Aequitas dan jadilah yang pertama!',
'registry-stats':'Statistik Registri','total-humans-stat':'Total Manusia','grant':'Hibah per Manusia','reg-fee':'Biaya Pendaftaran','free':'GRATIS','zkp-system':'Sistem ZKP','never-stored':'Tidak pernah disimpan',
'aeq-index-title':'Indeks Aequitas — Skor Kesetaraan Ekonomi Real-Time',
'current-index':'Indeks Saat Ini','gini-coeff':'Koefisien Gini','phase':'Fase Protokol',
'pools-title':'Pool Redistribusi','vel-pool':'Pool Kecepatan','liq-pool':'Pool Likuiditas','uni-pool':'Pool UBI','treasury':'Perbendaharaan',
'phases-title':'Fase Protokol',
'phase0':'Bootstrap · &lt;100 manusia · Cap: 50x fairShare',
'phase1':'Pertumbuhan · 100–10.000 · Cap: 20x fairShare',
'phase2':'Stabilitas · 10k–1M · Cap: 10x fairShare',
'phase3':'Kedewasaan · 1M+ · Cap: 3x fairShare',
'active-nodes':'Node Aktif','node1':'Node 1 — Railway (Utama)','node2':'Node 2 — Render (Sekunder)',
'node1-desc':'Server API utama · Produsen blok · P2P bootstrap · PostgreSQL · RPC untuk MetaMask',
'node2-desc':'Server API sekunder · Produsen blok · P2P peer · Sinkronisasi HTTP · PostgreSQL bersama',
'tech-specs':'Spesifikasi Teknis','metamask-config':'Konfigurasi MetaMask'
}
};
