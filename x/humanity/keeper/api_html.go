    ...
    <div id="node-guide" style="display:block;background:var(--card);border:1px solid rgba(245,166,35,0.2);border-radius:var(--radius);padding:24px;margin-top:4px">
      ...
      <table style="width:100%;border-collapse:collapse;margin-bottom:18px">
        ...
        <tr style="border-bottom:1px solid rgba(139,92,246,0.08)">
          ...
          <td style="font-size:0.61rem;color:var(--muted);padding:8px">No longer required. Validator authorization is now identity-based: your signed challenge response plus a verified NODE_OPERATOR_WALLET is enough — the primary permanently binds your wallet to your node's signing key the first time you connect, so one verified human can run exactly one validator without any shared secret. There is nothing to obtain from the network operator for this step.</td>
        </tr>
        <tr style="border-bottom:1px solid rgba(139,92,246,0.08);background:rgba(0,0,0,0.1)">
