...
function _buildNodeGuidePDF(lang) {
  ...
  var C={
    ...
    pt:{title:'Guia do Operador de Node Aequitas',sub:'Guia completo passo a passo · Aequitas Chain (Chain ID 1926)',badge:'BETA v0.1 · Open Source · Sem permissao · Sem stake necessario',
      ...
      s3:'3. Variaveis de Ambiente',e3:'Defina estas variaveis antes de iniciar o node. Variaveis marcadas SIM sao obrigatorias.',eh:['Variavel','Funcao','Necessaria?'],er:[['DATABASE_URL','String de conexao PostgreSQL: postgres://user:pass@host:5432/aequitas','SIM'],['RELAYER_PRIVATE_KEY','Chave privada (0x...) do EOA que assina registros on-chain','SIM'],['NODE_OPERATOR_WALLET','Carteira humana registrada que recebe recompensas de validador diarias','Para recomp.'],['RELAYER_ADDRESS','Endereco EOA correspondente a RELAYER_PRIVATE_KEY. Tem fallback mas defina explicitamente.','Recomendado'],['PORT','Porta HTTP para API + JSON-RPC. Padrao: 8080','NAO'],['PEER_NODES','URLs de bootstrap (separadas por virgula). Use a URL do node principal.','Recomendado'],['NODE_KEY','Hex 32 bytes para identidade P2P estaval. Auto-gerado se omitido.','NAO'],['IS_PRIMARY_NODE','"true" apenas no node principal designado. Ativa distribuicoes diarias.','NAO'],['RESET_STATE','"true" apaga o BD na inicializacao. DESTRUTIVO.','NAO']],
