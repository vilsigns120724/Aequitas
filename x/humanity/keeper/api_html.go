...
ru:{
  ...
  Contabo VPS,'node2-desc':'Вторичный API · Производитель блоков · P2P-пир · HTTP-синхронизация · Общее состояние PostgreSQL',
...
zh:{
  ...
  Contabo VPS,'node2-desc':'次要API · 区块生产者 · P2P对等 · HTTP同步 · 共享PostgreSQL状态',
...
it:{
  ...
  Contabo VPS,'node2-desc':'API secondario · Produttore blocchi · Peer P2P · Sincronizzazione HTTP · Stato PostgreSQL condiviso',
...
tr:{
  ...
  Contabo VPS,'node2-desc':'İkincil API · Blok üreticisi · P2P eşi · HTTP senkronizasyonu · Paylaşılan PostgreSQL durumu',
...
pt:{
  ...
  Contabo VPS,'node2-desc':'API secundário · Produtor de blocos · Par P2P · Sync HTTP · Estado PostgreSQL compartilhado',
...
ar:{
  ...
  Contabo VPS,'node2-desc':'API ثانوي · منتج كتل · نظير P2P · مزامنة HTTP · حالة PostgreSQL مشتركة',
...
hi:{
  ...
  Contabo VPS,'node2-desc':'द्वितीयक API · ब्लॉक उत्पादक · P2P पीयर · HTTP सिंक · साझा PostgreSQL स्टेट',
